# Generated by Django 5.0.3 on 2024-06-22 04:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, choices=[('Bhubaneswar', 'Bhubaneswar'), ('Cuttack', 'Cuttack'), ('Brahmapur', 'Brahmapur'), ('Puri', 'Puri'), ('Balasore', 'Balasore')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SI_units', models.CharField(blank=True, choices=[('Kilogram', 'Kilogram'), ('Gram', 'Gram'), ('Liter', 'Liter'), ('Units', 'Units')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_given', models.BooleanField(blank=True, default=False, null=True)),
                ('buying_status', models.CharField(blank=True, choices=[('BuyInProgress', 'BuyInProgress'), ('BuyCompleted', 'BuyCompleted'), ('BuyRejected', 'BuyRejected')], max_length=20, null=True)),
