...
urlpatterns = [
    ...
    path('rtg_blogs_search/', rtgBlogs.RTGBlogSearch.as_view(), name='rtg_blog_search'),
    # Vendor
    ...
    path('vendor_blogs_search/', vendorBlogs.VENDORBlogSearch.as_view(), name='vendor_blog_search'),
    ...
    path('sp_blogs_search/', spBlogs.SPBlogSearch.as_view(), name='sp_blog_search'),
